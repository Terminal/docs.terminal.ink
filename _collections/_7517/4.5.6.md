...
Delta encoding is used to reduce th file size of a film by storing pixels that do not change between each frames instead of replicating them for each frame.
