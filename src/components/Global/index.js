        ...
        render={data => (
          <Helmet htmlAttributes={{ lang : 'en' }}>
            ...
            { this.props.description
              ...
              : <meta property="og:description" content="Terminal.ink documentation, for Terminal services, such as ls"/>
            }
            { this.props.description
              ? <meta name="description" content={`${this.props.description} - ${data.site.siteMetadata.title}`}/>
              : <meta name="description" content={`Terminal.ink documentation, for Terminal services, such as ls - ${data.site.siteMetadata.title}`}/>
            }
            ...
            <meta name="keywords" content="discord, bots, terminal"/>
